  ...
  return (
    <div className={'card-body'}>
      <DishesEditPopup
        ...
        dish={curItem}
      ></DishesEditPopup>
      <CreateDishPopup popup={[createPopup, setCreatePopup]} restaurant={restaurant} signal={setSig}/>
      <div className={'d-flex mb-3'}>
        <CButton color={'success'} onClick={()=>setCreatePopup(true)}>Добавить</CButton>
      </div>
            ...
            <CCardBody>
              ...
              <CCardText>
                ...
                <div className={'d-flex justify-content-between pt-4'}>
                  <CButton color={'danger'} onClick={()=>deleteDish(menu)}>Удалить</CButton>
                  <CButton
                    color={'primary'}
                    onClick={() => {
                      setCurItem(menu)
